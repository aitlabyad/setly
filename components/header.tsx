...
export default function Header() {
  ...
  return (
    <nav className='flex  bg-gray1 h-10 sm:w-[1200px] w-11/12  items-center justify-between  pt-4 sm:pt-8'>
      ...
      <div className='cursor-pointer' ><a href="https://api.whatsapp.com/send?phone=212661807470"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 19 19" fill="none">
      ...
      <div >
        <Menu placement="bottom-end">
          ...
          <MenuItem className='p-0 m-0 w-full text-[16px] text-center text-gray1  font-light  leading-6 hover:text-gold' placeholder={undefined}><a href="/">Home</a> </MenuItem>
            <MenuItem className='p-0 m-0 w-full text-[16px] text-center text-gray1  font-light  leading-6 hover:text-gold' placeholder={undefined}><a href="#first-section">About</a> </MenuItem>
            <MenuItem className='p-0 m-0 w-full text-[16px] text-center text-gray1  font-light  leading-6 hover:text-gold'  placeholder={undefined}><a first-section href="#first-section">Contact</a></MenuItem>
