  ...
  return (
    <nav className='flex  bg-gray1 h-10 sm:w-[1200px] w-11/12  items-center justify-between  pt-4 sm:pt-8'>
      ...
      <div className='cursor-pointer' ><a href="https://api.whatsapp.com/send?phone=212661343109"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 19 19" fill="none">
          <g clip-path="url(#clip0_163_12019)">
        ...
        <Menu placement="bottom-end">
          <MenuHandler>
            <Button className='bg-transparent'><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 15 15" fill="none">
              <path d="M1.85229 4.32197H12.9659" stroke="#596780" stroke-width="0.926137" stroke-linecap="round" />
              <path d="M1.85229 7.4091H12.9659" stroke="#596780" stroke-width="0.926137" stroke-linecap="round" />
              <path d="M1.85229 10.4962H12.9659" stroke="#596780" stroke-width="0.926137" stroke-linecap="round" />
            </svg></Button>
          </MenuHandler>
          <MenuList>
