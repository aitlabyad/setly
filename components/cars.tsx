      ...
      <div className="w-[340px] sm:w-[1200px] justify-center items-center  px-8 pt-6  " >
        ...
        >
          ...
          {cars.slice(0, 10).map(function (car) {
            return (
              <div key={car.model} className="flex flex-row">
            ...
            <div className="w-[280px] bg-white p-2 rounded-xl ">
                    ...
                    <div className="flex flex-row mt-2">
                        <div>
                            ...
                            <svg
                                ...
                                fill="none"
                            >
                                <g clipPath="url(#clip0_162_11237)">
                                    <path
                        ...
                        <h3 className="flex items-center">
                            <span className="text-gold text-sm">{car.price} </span>
                ...
                <div className="flex flex-col text-black1  text-[14px] tracking-tight  text-bold leading-[1rem]">
                    ...
                    <h3 className="text-black1 text-[12px] font-extralight">{car.model}</h3>
                ...
                <div className="flex flex-row   justify-center gap-0">
                    ...
                    <div className="  flex flex-row items-center justify-between">
                        ...
                        <p className=" text-gray2  text-[12px] font-light tracking-wide ">{car.fuelType}</p>
                    </div>
                    <div className=" flex flex-row items-center justify-between">
                        <div className="items-center p-1"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 9 9" fill="none">
                            <g clipPath="url(#clip0_162_11249)">
                        ...
                        <p className=" text-gray2  text-[12px] font-light tracking-wide ">{car.seats}</p>
                    </div>
                    <div className=" flex flex-row items-center justify-between">
                        ...
                        <p className=" text-gray2  text-[12px] font-light tracking-wide ">{car.transmission}</p>
                    </div>
                    <div className="  flex flex-row items-center justify-between">
                        <div className="items-center p-1"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 9 9" fill="none">
                            <g clipPath="url(#clip0_162_11259)">
                        ...
                        <p className=" text-gray2  text-[12px] font-light tracking-wide ">{car.type}</p>
                    </div>
                ...
                <div className="flex justify-center ">
                    ...
                    <Link
                        className=" flex bg-gold text-white1 w-[120px] p-2 rounded-xl justify-center items-start "
                        href={{
